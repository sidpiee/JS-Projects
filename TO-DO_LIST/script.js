document.addEventListener("DOMContentLoaded", function () {
  ...
  function rendertask(task) {
    ...
    li.className =
      "w-120 bg-linear-to-r from-pink-200 to-rose-300  backdrop-blur-xl flex justify-around gap-20 items-center p-3 rounded-xl shadow-lg border-4 border-solid border-pink-300 m-2";
